...
x = keras.layers.Dense(p_x * p_y * 64, activation="relu")(decoder_inputs)
#テンソルの形状を変換
x = keras.layers.Reshape((p_x,p_y, 64))(x)
# Deconv層
...
#学習データの取得
#---------------------
x_train = get_data("./face_img")

#-------------------
#学習開始
#-------------------
history = vae.fit(x_train,x_train,epochs=2000,batch_size=50)

#--------------------
#モデルの保存
#--------------------
#学習モデルの保存
vae.save("face_vae.h5")
